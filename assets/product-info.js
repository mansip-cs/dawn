  ...
  customElements.define(
    ...
    class ProductInfo extends HTMLElement {
      ...
      getSelectedVariant(productInfoNode) {
        const variantContainer = productInfoNode.querySelector('variant-selects');

       const selectedVariant = variantContainer?.querySelector('[data-selected-variant]')?.textContent;
