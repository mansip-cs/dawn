...
//     this.querySelectorAll('.product-form__input').forEach((fieldset) => {

//       const optionName = fieldset.querySelector('legend')?.textContent?.trim();

    
//       if (optionName && optionName.toLowerCase().includes('color')) return;
...
//       console.log("Main Active Value:", selectedValue);

//       const bundleRadio = document.querySelector(
//         `.product-bundle-item input[type="radio"][value="${selectedValue}"]`
//       );
//       console.log("Bundle Match Found:", bundleRadio);
//       if (bundleRadio) {
...
//       const requestUrl = this.buildRequestUrl(productUrl, optionValues, sectionId);

//       this.updateBundleVariant(requestUrl);
//     });
//   }

//   buildRequestUrl(url, optionValues, sectionId) {
//     const params = [];
...
//   updateBundleVariant(url) {
//     fetch(url)
//       .then((response) => response.text())
//       .then((responseText) => {
//         const html = new DOMParser().parseFromString(responseText, 'text/html');

//         const newVariantSelects = html.querySelector('bundle-variant-selects');

//         if (newVariantSelects) {
//           this.innerHTML = newVariantSelects.innerHTML;
//         }

//         const variantJson = html.querySelector('[data-selected-variant]')?.textContent;

//         if (variantJson) {
//           const variant = JSON.parse(variantJson);
//           console.log('Bundle Variant Updated:', variant);
//         }
//       });
//   }
